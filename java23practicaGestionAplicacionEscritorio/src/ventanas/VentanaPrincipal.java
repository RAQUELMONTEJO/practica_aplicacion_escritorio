...
public class VentanaPrincipal extends JFrame implements ActionListener {
	...
	private PanelBorrarCliente panelborcliente = new PanelBorrarCliente();
...
//		menuclientes.setBorder(blackline);
//		menuRopa.setBorder(blackline);
//		menuayuda.setBorder(blackline);
		...
		barrademenu.add(new JSeparator());
		menuayuda.setBackground(Color.RED);
